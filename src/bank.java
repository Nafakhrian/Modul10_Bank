...
public class bank {
  ...
  try{ 
    do{ 
      str = JOptionPane.showInputDialog(null, "Masukkan 4 Digit PIN Anda:","ATM Mandiri Malang",0); 
...
JOptionPane.showInputDialog(null,"[1] INFORMASI SALDO \n[2] PENYETORAN \n[3] PENARIKAN \n[4] PETUNJUK \n[5] KELUAR \n\nMasukkan Pilihan Menu:","Pilih Transaksi",3); 
  ...
  JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM Mandiri Lawang, silahkan ambil kartu ATM Anda."); 
    System.exit(0); 
  ...
  z=JOptionPane.showConfirmDialog(null,"Melanjutkan transaksi lain?","ATM Mandiri Lawang", JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain 
    if (z==0) 
      break; 
    else 
  ...
  JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM Mandiri Lawang, silahkan ambil kartu ATM Anda."); 
    ...
    z=JOptionPane.showConfirmDialog(null,"Melanjutkan transaksi lain?","ATM Mandiri Lawang", 
...
if (z==0){ 
  ...
  { 
JOptionPane.showMessageDialog(null,"Untuk bantuan nasabah,\nsilahkan menghubungi call center 515151 (Gratis)","Kartu ATM anda diblokir!",0); 
  System.exit(0);} 
  } 
